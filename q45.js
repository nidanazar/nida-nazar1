...
// variable called alien_color and assign it a value of 'green', 'yellow', or 'red'.• Write an if statement to test whether the alien’s color is green. If it is, print
...
// stored correctly.
function car(manufacturer, model, color, year, key, boolen) {
    var car = { manufacturer: manufacturer, model: model, color: color, year: year, key: key };
    return car;
}
console.log("Toyota", "Corolla", ["color", "red"], ["year", 2020]);
console.log("Ford", "Fiesta", ["color", "SkyBlue"], ["sunroof", true]);
